...
Y = dataset.iloc[:,40+1].values#Company for which analysis is to be done +1
X = X[:,68:]
...
#plotting first 100 test points (red) vs model prediction (blue)
length = range(0,802)
plt.scatter(length, Yut_test[0:802] , color = 'red')
plt.plot(length , Yut_pred[0:802] , color = 'blue')
