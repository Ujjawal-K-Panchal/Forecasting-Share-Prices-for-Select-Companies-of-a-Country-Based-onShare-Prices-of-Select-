...
X_train,X_test,Y_train,Y_test = train_test_split(X,Y_theta,random_state = 0, test_size = 0.2)
...
reg = RandomForestClassifier(n_estimators = 15, random_state = 0) # 15 by experimentation.
